            ...
            <div class="mb-3">
                ...
                <div class="row mar-y-o">
                    ...
                    <div class="col-md-4 col-12 question-btn">
                        <button id="question_add_review" class="btn input-color" data-toggle="modal" data-target="#questionModal">Add your review</button>
                    </div>
                </div>
            </div>
            <div class="mb-3">
                ...
                <div class="row mar-y-o">
                    ...
                    <div class="col-md-4 col-12 question-btn">
                        <button id="explanation_add_review" class="btn input-color" data-toggle="modal" data-target="#questionModal">Add your review</button>
                    </div>
                </div>
            </div>
            <div class="mb-3">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-7 col-12">
                                ...
                                <div id="add_review__el" class="page-content rounded overflow-auto hei65 hei65-sm scroll bg-white p-2 mb-3">

                                </div>
                            </div>
                            <div class="col-md-5 col-12">
                                <div id="all_comments_ex" class="page-content rounded overflow-auto hei30 scroll bg-white p-2 mb-3">
                                </div>
                                <div>
                                    <div class="form-group">
                                        <textarea class="form-control ckeditor" name="comment_ex" placeholder="your comment"></textarea>
                                    </div>
                                    <div class="form-group d-flex justify-content-between">
                                        <button id="add_comment_ex" class="btn input-color">Add</button>
                                        <button id="send_comment_ex" class="btn input-color">Send Your Review</button>
                                    </div>
...
<script src="../js/teacherAddReviews/script_exercises.js" defer></script>