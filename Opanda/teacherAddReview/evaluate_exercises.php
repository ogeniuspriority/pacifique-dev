                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-7 col-12">
                                ...
                                <div id="add_review__el" class="page-content rounded overflow-auto hei65 hei65-sm scroll bg-light p-2 mb-3">

                                </div>
                            </div>
                            <div class="col-md-5 col-12">
                                <div id="all_comments_ex" class="page-content rounded overflow-auto hei25 scroll bg-light p-2 mb-3">
                                </div>
                                <div>
                                    <div class="form-group">
