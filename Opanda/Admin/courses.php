    ...
    <div class="col-lg-8 sidebar rounded content-size p-1">
        <div class="content-header d-flex justify-content-between py-2 m-3">
            <div class="form-group d-block">
                <button id="add_review" type="submit" name="submit" class="btn input-color" data-toggle="modal" data-target="#coursesModal">See Reviews On This Page</button>
            </div>
            <div class="d-flex">
        ...
        <div id="content" class="page-content rounded overflow-auto hei40 scroll bg-white p-2 m-3">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-5 col-12">
                        ...
                        <div id="all_comments" class="page-content rounded overflow-auto hei55 scroll bg-white p-2 mb-3">
                        </div>
                        <p class="text-center" id="message"></p>
                        <div id="pagination_comments" class="m-3 text-center" aria-label="Page navigation example">
                        </div>
                    </div>
                </div>
            </div>
